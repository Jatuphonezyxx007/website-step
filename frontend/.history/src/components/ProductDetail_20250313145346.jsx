...
const ProductDetail = () => {
  ...
  return (
    <div className="product-detail">
      ...
      >
        <SwiperSlide>
          <img src={`http://localhost:3000/products/${product.images_main}`} alt={product.product_name} />
        </SwiperSlide>
        {product.supplementary_images &&
          product.supplementary_images.map((img, index) => (
            <SwiperSlide key={index}>
              <img src={`http://localhost:3000/products/${img}`} alt={`Supplementary ${index}`} />
            </SwiperSlide>
          ))}
      </Swiper>
      ...
      >
        <SwiperSlide>
          <img src={`http://localhost:3000/products/${product.images_main}`} alt="Main Thumbnail" />
        </SwiperSlide>
        {product.supplementary_images &&
          product.supplementary_images.map((img, index) => (
            <SwiperSlide key={index}>
              <img src={`http://localhost:3000/products/${img}`} alt={`Thumbnail ${index}`} />
            </SwiperSlide>
          ))}
      </Swiper>
      </div>
