...
//   // ✅ เมื่อเลือกสินค้าให้ล้างค่าค้นหา
//   const handleSelectProduct = () => {
//     setSearchTerm(""); // ✅ ล้างค่าค้นหา
//     setSearchResults([]); // ✅ ล้างรายการค้นหา
//   };
...
//                     <Link to={`/edit-product/${product.product_id}`} onClick={handleSelectProduct} className="block text-gray-700 dark:text-white">
