...
//     productName?: string;
//     email?: string;
//     categoryId?: string; // or number, adjust type accordingly
//   };
//   // categories array from table categories, each with value and label
//   categories?: { value: string; label: string }[];
// }

// export default function DefaultInputs({ initialValues = {}, categories = [] }: DefaultInputsProps) {
//   // controlled states สำหรับข้อมูลต่าง ๆ
//   const [productName, setProductName] = useState(initialValues.productName || "");
//   const [email, setEmail] = useState(initialValues.email || "");
//   const [selectedCategory, setSelectedCategory] = useState(initialValues.categoryId || "");

//   // เมื่อ initialValues เปลี่ยนแปลง ให้ update state
//   useEffect(() => {
//     setProductName(initialValues.productName || "");
//     setEmail(initialValues.email || "");
...
//   // ถ้าไม่ส่ง categories เข้ามา ให้ fallback ค่า default (หรือเปลี่ยนเป็น [] เพื่อ fetch จาก API แยก)
//   const defaultOptions = [
//     { value: "marketing", label: "Marketing" },
//     { value: "template", label: "Template" },
//     { value: "development", label: "Development" },
//   ];
//   const selectOptions = categories.length > 0 ? categories : defaultOptions;
...
//             onChange={handleSelectChange}
//             // สมมุติว่า Select component รองรับ prop value เพื่อ pre-select option
...
export default function DefaultInputs({ initialValues = {}, categories = [] }: DefaultInputsProps) {
  ...
  // ถ้าไม่ส่ง categories เข้ามา ให้ fallback ค่า default
  const defaultOptions = [
    { value: "no data", label: "ไม่มีรายการสินค้า" }
  ];
  const selectOptions = categories.length > 0 ? categories : defaultOptions;
