...
//   };
//   categories?: { value: string; label: string }[];
//   onChange?: (field: string, value: string) => void; // เพิ่มฟังก์ชันนี้
// }

// export default function DefaultInputs({ initialValues = {}, categories = [], onChange }: DefaultInputsProps) {
//   const [productName, setProductName] = useState(initialValues.productName || "");
//   const [email, setEmail] = useState(initialValues.email || "");
//   const initialCategory = initialValues.categoryId !== undefined ? String(initialValues.categoryId) : "";
//   const [selectedCategory, setSelectedCategory] = useState(initialCategory);
...
//   useEffect(() => {
//     if (initialValues.productName !== productName) setProductName(initialValues.productName || "");
//     if (initialValues.email !== email) setEmail(initialValues.email || "");
//     if (String(initialValues.categoryId) !== selectedCategory) setSelectedCategory(initialValues.categoryId !== undefined ? String(initialValues.categoryId) : "");
//   }, [initialValues]);

//   const handleInputChange = (field: string, value: string) => {
//     if (field === "productName") setProductName(value);
//     if (field === "email") setEmail(value);
//     if (field === "categoryId") setSelectedCategory(value);
...
export default function DefaultInputs({ initialValues = {}, categories = [], onChange }: DefaultInputsProps) {
  ...
  // ตรวจสอบเมื่อ initialValues เปลี่ยน
  useEffect(() => {
    setProductName(initialValues.productName || "");
    setSelectedCategory(initialValues.categoryId !== undefined ? String(initialValues.categoryId) : "");
  }, [initialValues]);
  ...
  const handleInputChange = (field: string, value: string) => {
    ...
    // ตรวจสอบว่า onChange ถูกเรียกใช้ทุกครั้งที่ข้อมูลเปลี่ยน
