...
export default function DefaultInputs({ initialValues = {}, categories = [] }: DefaultInputsProps) {
  ...
  // ถ้าไม่ส่ง categories เข้ามา ให้ใช้ defaultOptions เป็น fallback
  const defaultOptions = [
    { value: "marketing", label: "Marketing" },
    { value: "template", label: "Template" },
    { value: "development", label: "Development" },
  ];
  const selectOptions = categories && categories.length > 0 ? categories : defaultOptions;
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <Select
            ...
            onChange={handleSelectChange}
            // สมมุติว่า Select component รองรับ prop value สำหรับ pre-select option
