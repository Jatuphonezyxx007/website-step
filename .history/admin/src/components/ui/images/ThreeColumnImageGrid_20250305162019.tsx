    ...
    const fetchExistingImages = async () => {
      ...
      try {
        ...
        if (data.success) {
          ...
          // ✅ แปลงภาพรอง (`supplementary_images`)
          if (data.product.supplementary_images && data.product.supplementary_images.length > 0) {
          ...
          setImages(existingImages); // ✅ ตั้งค่ารูปภาพจากฐานข้อมูล
