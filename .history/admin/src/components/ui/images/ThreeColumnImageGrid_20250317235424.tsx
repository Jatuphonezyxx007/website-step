    ...
    const fetchExistingImages = async () => {
      ...
      try {
        ...
        if (data.success) {
          ...
          if (data.product.main_image) {
            existingImages.push({
              product_image_id: data.product.main_image_id, // ดึง product_image_id ของภาพหลัก
              filename: data.product.main_image,
              fileBuffer: `/products/${data.product.main_image}`,
              existing: true,
            });
          ...
          if (data.product.supplementary_images) {
            data.product.supplementary_images.forEach((img) => {
              existingImages.push({
                product_image_id: img.product_image_id, // ดึง product_image_id ของภาพรอง
                filename: img.filename,
                fileBuffer: `/products/${img.filename}`,
                existing: true,
              });
            });
          }
