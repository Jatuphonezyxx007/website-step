  ...
  useEffect(() => {
    const fetchExistingImages = async () => {
      ...
      try {
        ...
        if (data.success) {
          let existingImages = []; // ✅ ต้องกำหนดค่าเริ่มต้นให้ existingImages
          ...
          setImages(existingImages); // ✅ อัปเดตค่า images
          onImagesUpdate(existingImages); // ✅ ส่งค่ากลับไปให้ EditForm.tsx
        }
      } catch (error) {
        console.error("🚨 Error fetching images:", error);
      }
