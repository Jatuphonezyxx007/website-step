...
<ComponentCard title="ข้อมูลพนักงาน">
  <div className="grid grid-cols-2 gap-4">
    <div className="flex flex-col">
      <label className="mb-1 text-sm font-medium text-gray-700">ชื่อพนักงาน</label>
      <Input placeholder="ชื่อพนักงาน" />
    </div>
    <div className="flex flex-col">
      <label className="mb-1 text-sm font-medium text-gray-700">นามสกุลพนักงาน</label>
      <Input placeholder="นามสกุลพนักงาน" />
    </div>
  </div>
</ComponentCard>
