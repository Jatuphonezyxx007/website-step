...
export default function AdminLogin() {
  ...
  return (
    <div className="">
      ...
      >
        <Card className="container-box min-h-screen flex items-center justify-center bg-gray-100 w-full max-w-lg shadow-2xl rounded-2xl bg-white border border-gray-200 p-8">
