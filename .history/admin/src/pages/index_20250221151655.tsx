    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100">
      ...
      >
        <Card className="w-full max-w-md shadow-2xl rounded-2xl">
          <CardHeader className="text-center bg-gradient-to-r from-purple-500 to-indigo-500 text-white rounded-t-2xl">
          ...
          <form onSubmit={handleLogin}>
            <CardBody className="space-y-5">
              ...
              <div className="relative w-full flex w-full flex-wrap md:flex-nowrap gap-4">
                <Input
                  label="รหัสผ่าน"
