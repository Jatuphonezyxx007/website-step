...
//                 <DropdownTrigger>
//                   <Button variant="bordered">หมวดหมู่</Button>
//                   </DropdownTrigger>
    ...
    >
      <div className="navbar-container">
        ...
        <div className="search-category-container">
          ...
          <Dropdown backdrop="blur">
            <DropdownTrigger>
              <Button variant="bordered" startContent={<Squares2X2Icon className="w-5 h-5" />}>หมวดหมู่</Button>
            </DropdownTrigger>
            <DropdownMenu aria-label="หมวดหมู่สินค้า" variant="faded">
              {categories.length > 0 ? (
                categories.map((category) => (
                  <DropdownItem
                    key={category.id}
        ...
        <Dropdown>
          ...
          <DropdownMenu aria-label="บัญชีของฉัน">
            <DropdownItem onClick={() => navigate('/admin/login')}>เข้าสู่ระบบ</DropdownItem>
            <DropdownItem onClick={() => navigate('/profile')}>โปรไฟล์</DropdownItem>
            <DropdownItem onClick={() => navigate('/settings')}>ตั้งค่า</DropdownItem>
          </DropdownMenu>
        </Dropdown>
      </div>
    </motion.nav>
