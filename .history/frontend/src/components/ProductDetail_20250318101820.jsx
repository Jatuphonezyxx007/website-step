...
const ProductDetail = () => {
  ...
  {/* 🔹 แสดงแบรนด์ และ SKU ถ้ามีข้อมูล */}
  {/* <p className="text-lg font-semibold text-gray-500 mt-2">
    <span className="inline-block w-24">แบรนด์:</span> {product.brand || "-"}  
    |  
    <span className="inline-block w-24">SKU:</span> {product.sku || "-"}
  </p> */}
<br />
<hr />
  {/* 🔥 รายละเอียดสินค้า */}
  ...
  <ul className="list-none ml-6 space-y-2 text-gray-700 mt-3">
    {product.specs?.split("\n").map((spec, index) => (
      <li key={index} className="flex items-center gap-2">
        <span className="text-blue-500 font-bold">•</span> {/* Bullet Point สีฟ้า */}
