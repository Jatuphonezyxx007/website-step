...
{/* <div className="box-border size-100 border-4 p-4 ...">
      <div className="mt-4">
  ...
  {/* ข้อความอธิบายใต้โมเดล */}
  <p className="mt-4 text-gray-600 text-sm text-center max-w-xl">
    ใช้เมาส์เพื่อหมุน ซูม หรือเลื่อนดูโมเดล 3 มิติของคุณด้านบน<br />
    รองรับไฟล์ .obj, .glb, .gltf และ .stl ขนาดไม่เกิน 1GB
  </p>
</div>
