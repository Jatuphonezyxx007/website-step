  ...
  return (
    <footer className="footer-container">
      ...
      <div className="footer-bottom">
        ...
        <button className="line-contact-btn"><a href="https://www.linkedin.com/company/step-solutions-th" target="_blank" rel="noopener noreferrer">สอบถาม - สั่งซื้อ ผ่าน @LINE สะดวกกว่า</a></button>
      </div>
    </footer>
  );
}
