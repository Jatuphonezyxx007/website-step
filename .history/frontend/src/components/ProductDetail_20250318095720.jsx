...
const ProductDetail = () => {
  ...
  const totalSlides = product.supplementary_images
  ? product.supplementary_images.length + 1 // +1 คือ main_image
  : 1;
...
<Swiper
  loop={totalSlides > 1}  // ✅ เปิด loop ก็ต่อเมื่อมีรูปมากกว่า 1 รูป
  spaceBetween={10}
  navigation={true}
  thumbs={{ swiper: thumbsSwiper }}
