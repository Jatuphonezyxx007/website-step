...
//             className="product-image"
//             src={`http://localhost:3000/products/${product.main_image}` || "https://via.placeholder.com/500x500"}
//             width="100%"
//             height="100%"
//             radius="lg"
//           />
      ...
      {/* <div className={`filter-sidebar ${window.innerWidth > 1024 ? "expanded" : isOpen ? "expanded" : "collapsed"}`}>
        ...
        {(isOpen || window.innerWidth > 1024) && (
          <form>
            ...
            <div className={`filter-sidebar ${window.innerWidth > 1024 ? "expanded" : isFilterOpen ? "expanded" : "collapsed"}`}>
        {window.innerWidth <= 1024 && (
          <button
