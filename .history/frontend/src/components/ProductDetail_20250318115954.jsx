      ...
      <div className="mt-4">
        ...
        {existingModelUrl ? (
          ...
          <p>No 3D model available for this product.</p>
            ...
            <Card className="w-full max-w-4xl bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700 shadow-2xl rounded-xl p-6 border border-gray-600 ring-2 ring-purple-500/50">
        {/* Title */}
        <motion.h1
          ...
          {existingModelUrl ? (
            ...
            >
              ...
              <model-viewer
                ...
                auto-rotate
                camera-controls
                className="w-[80%] h-[500px] rounded-xl shadow-xl border border-gray-500"
              ></model-viewer>

              {/* Glow Effect */}
              <div className="absolute inset-0 bg-white opacity-10 blur-lg rounded-xl group-hover:opacity-20 transition-all"></div>
            </motion.div>
          ) : (
            <motion.p
