...
//   clearExpired: true,
//   checkExpirationInterval: 900000, // ตรวจสอบ session ทุก 15 นาที
//   expiration: 86400000, // อายุ session 1 วัน
// });

// app.use(session({
//   key: 'user_sid',
//   secret: '11111', // เปลี่ยนเป็น key ที่ปลอดภัย
//   resave: false,
...
// สร้าง Express app
const app = express();
const port = process.env.PORT || 5000; // ใช้ค่าจาก .env หากมี
...
// ✅ ต้องเรียกใช้ session ก่อน express.json() และ cors()
app.use(session({
  key: 'user_sid',
  secret: '11111', // เปลี่ยนเป็น key ที่ปลอดภัย
  resave: false,
...
// const session = require("express-session");
// const MySQLStore = require("connect-mysql2")(session); // ✅ ใช้ session ที่ import มาถูกต้อง
...
//     }
//   }
// }, pool.promise()); // ใช้ pool แบบ promise()

// // ใช้ session middleware
// app.use(session({
//   key: "user_sid",
//   secret: process.env.SESSION_SECRET || "11111",
//   store: sessionStore,
//   resave: false,
//   saveUninitialized: false,
