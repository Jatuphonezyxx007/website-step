...
app.get('/api/products/:product_id', async (req, res) => {
  try {
    const { product_id } = req.params;
    console.log("Fetching product with ID:", product_id); // ตรวจสอบค่าที่ส่งมา
    ...
    console.log("Product Query Result:", productRows); // ตรวจสอบผลลัพธ์
    ...
    console.log("Images Query Result:", imagesRows); // ตรวจสอบผลลัพธ์
