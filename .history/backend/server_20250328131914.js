...
//   destination: (req, file, cb) => {
//     // กำหนดที่เก็บไฟล์ในโฟลเดอร์ admin/public/datasheet
//     const dir = path.join(__dirname, '../admin/public/datasheet');
...
//   },
//   filename: (req, file, cb) => {
//     const product_name = req.body.product_name || 'default'; // ใช้ชื่อสินค้าจาก body หรือ default
//     const fileExtension = path.extname(file.originalname); // ได้รับนามสกุลไฟล์ (เช่น .pdf, .png)
//     const fileName = `${product_name.toLowerCase().replace(/\s+/g, '-')}${fileExtension}`;
//     cb(null, fileName);
//   }
// });
